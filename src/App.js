      ...
      <AuthProvider value={{ user }}>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/admin/index"
              element={user ? <HomeAdmLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/postlist"
              element={user ? <DashboardLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/newsletter/post/edit/:id"
              element={user ? <EditPostLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/materials/post/edit/:id"
              element={user ? <EditMaterialsLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/createpost/creatematerials"
              element={user ? <CreateMaterialsLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/createpost/createnewsletter"
              element={user ? <CreateNewsletterLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/users"
              element={user ? <UsersLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/users/createuser"
              element={user ? <CreateUsersLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/users/edit/:userId"
              element={user ? <EditUserPageLayout /> : <Navigate to="/admin/" />}
            />
            <Route
              path="/admin/profile/"
              element={user ? <ProfileAdminLayout /> : <Navigate to="/admin/" />}
            />
            UsersLayout
          </Routes>
        </BrowserRouter>
